    ...
    <div className="site-shell">
      ...
      <main>
        <Routes>
          ...
          <Route path="/luxury-rooms-bhakkar" element={<LocalLandingPage variant="luxury" />} />
          <Route path="/family-rooms-bhakkar" element={<LocalLandingPage variant="family" />} />
          <Route path="/long-stay-accommodation-bhakkar" element={<LocalLandingPage variant="longStay" />} />
