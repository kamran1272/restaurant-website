...
<<<<<<< HEAD
  ...
  },
  {
    ...
    description: 'Browse the Pakistani menu, reserve a table, or order curries, platters, breakfast, and desserts for local delivery.',
  },
  {
    title: 'Long stay',
    description: 'A clearer home for extended-visit information, rates, and arrangements when long-stay enquiries are ready to be handled online.',
  },
  {
    title: 'Guest services',
    description: 'A clear place to introduce WiFi, AC, cleaning, mess, and laundry when those services are confirmed and ready to support.',
  },
  {
