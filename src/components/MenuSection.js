...
const CATEGORY_FILTERS = [
  ...
  { value: 'Starters', label: 'Starters', categories: ['Street Food and Snacks', 'Breakfast and Brunch'] },
  { value: 'BBQ', label: 'BBQ', categories: ['BBQ and Grills'] },
  {
    value: 'Main Course',
    label: 'Main Course',
    categories: ['Karahi and Handi', 'Nihari and Slow Cooked', 'Tawa and Curry', 'Seafood', 'Chinese and Fusion'],
  },
  { value: 'Rice', label: 'Rice', categories: ['Biryani and Pulao', 'Bread and Rice Sides'] },
  { value: 'Drinks', label: 'Drinks', categories: ['Drinks'] },
